...
var ruleNames =  [ "program", "sequence", "action", "booleanLiteral", "hexadecimalLiteral", 
                   "decimalLiteral", "octalLiteral", "stringLiteral", "variableAccess", 
                   "assignment", "id", "operator", "ifAction", "label", 
                   "gotoAction", "quit", "store", "load", "storePop", "type", 
...
rpnParser.RULE_sequence = 1;
rpnParser.RULE_action = 2;
rpnParser.RULE_booleanLiteral = 3;
rpnParser.RULE_hexadecimalLiteral = 4;
rpnParser.RULE_decimalLiteral = 5;
rpnParser.RULE_octalLiteral = 6;
rpnParser.RULE_stringLiteral = 7;
rpnParser.RULE_variableAccess = 8;
rpnParser.RULE_assignment = 9;
rpnParser.RULE_id = 10;
rpnParser.RULE_operator = 11;
rpnParser.RULE_ifAction = 12;
...
ProgramContext.prototype.sequence = function() {
...
function SequenceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = rpnParser.RULE_sequence;
    return this;
}
...
SequenceContext.prototype.action = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
rpnParser.SequenceContext = SequenceContext;

rpnParser.prototype.sequence = function() {

    var localctx = new SequenceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 2, rpnParser.RULE_sequence);
...
rpnParser.prototype.action = function() {
    ...
    this.enterRule(localctx, 4, rpnParser.RULE_action);
    try {
        this.state = 123;
        this._errHandler.sync(this);
...
rpnParser.prototype.booleanLiteral = function() {
    ...
    this.enterRule(localctx, 6, rpnParser.RULE_booleanLiteral);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 125;
...
rpnParser.prototype.hexadecimalLiteral = function() {
    ...
    this.enterRule(localctx, 8, rpnParser.RULE_hexadecimalLiteral);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 127;
...
rpnParser.prototype.decimalLiteral = function() {
    ...
    this.enterRule(localctx, 10, rpnParser.RULE_decimalLiteral);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 129;
...
rpnParser.prototype.octalLiteral = function() {
    ...
    this.enterRule(localctx, 12, rpnParser.RULE_octalLiteral);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 131;
...
rpnParser.prototype.stringLiteral = function() {
    ...
    this.enterRule(localctx, 14, rpnParser.RULE_stringLiteral);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 133;
...
rpnParser.prototype.variableAccess = function() {
    ...
    this.enterRule(localctx, 16, rpnParser.RULE_variableAccess);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 135;
...
rpnParser.prototype.assignment = function() {
    ...
    this.enterRule(localctx, 18, rpnParser.RULE_assignment);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 167;
...
rpnParser.prototype.id = function() {
    ...
    this.enterRule(localctx, 20, rpnParser.RULE_id);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 206;
...
rpnParser.prototype.operator = function() {
    ...
    this.enterRule(localctx, 22, rpnParser.RULE_operator);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 219;
...
IfActionContext.prototype.sequence = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
rpnParser.prototype.ifAction = function() {
    ...
    this.enterRule(localctx, 24, rpnParser.RULE_ifAction);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 221;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===rpnParser.T__87) {
            this.state = 230;
            this.match(rpnParser.T__87);
            this.state = 231;
            localctx.falseActions = this.sequence();
            this.state = 232;
